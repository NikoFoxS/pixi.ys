namespace ys
{
    export class Tween extends PIXI.utils.EventEmitter
    {
      /**
         * 不做特殊处理
		 * @constant {number} ys.Tween.NONE
         * @private
		 */
        private static NONE = 0;
		/**
         * 循环
		 * @constant {number} ys.Tween.LOOP
         * @private
		 */
        private static LOOP = 1;
		/**
         * 倒序
		 * @constant {number} ys.Tween.REVERSE
         * @private
		 */
        ...
        public static pauseTweens(target: any): void {
            ...
            let tweens: ys.Tween[] = ys.Tween._tweens;
            for (let i = tweens.length - 1; i >= 0; i--) {
                if (tweens[i]._target == target) {
                    tweens[i].paused = true;
                }
		 ...
		 * @param ease {ys.Ease} Easing algorithm
		 * @returns {ys.Tween} Tween object itself
         * @version ys 2.4
         * @platform Web,Native
         * @language en_US
		 */
		 ...
		 * @param ease {ys.Ease} 缓动算法
		 * @returns {ys.Tween} Tween对象本身
         * @version ys 2.4
         * @platform Web,Native
         * @language zh_CN
		 */
         ...
         * @example
         * <pre>
         *  ys.Tween.get(display).call(function (a:number, b:string) {
		...
		/**
         * Execute
		 * @param tween {ys.Tween} The Tween object to be operated. Default: this
		 * @returns {ys.Tween} Tween object itself
         * @version ys 2.4
         * @platform Web,Native
         * @language en_US
		...
		/**
         * 执行
		 * @param tween {ys.Tween} 需要操作的 Tween 对象，默认this
		 * @returns {ys.Tween} Tween对象本身
         * @version ys 2.4
         * @platform Web,Native
         * @language zh_CN
